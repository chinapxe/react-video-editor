        ...
        if (
          ...
          if (!timelineClip) {
            const commonProps: any = {
              ...
              text: clipName,
              src: clip.src,
              lockMovementX: clip.type === "Transition" ? true : !!(clip as any)?.locked,
              lockMovementY: clip.type === "Transition" ? true : !!(clip as any)?.locked,
              lockScalingX: !!(clip as any)?.locked,
              lockScalingY: !!(clip as any)?.locked,
              lockSkewingX: !!(clip as any)?.locked,
              lockSkewingY: !!(clip as any)?.locked,
              lockRotation: !!(clip as any)?.locked,
              hasControls: !(clip as any)?.locked,
            };
